...
4. Verify `integrity_check`, `foreign_key_check`, schema version 2 and migration ledger, durable counts, lifecycle relationships, administrator initialization, digest-only sessions, HA hydration where appropriate, and HTTP 200 from `/healthz`.
