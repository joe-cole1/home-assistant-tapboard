...
export const tap2Trace2035 = [
  ...
  sample(200, 2, 619.8),
  sample(400, 1, 638.8),
  sample(400, 2, 613.68), // ~1.20 / ~6.32 oz coupling
  sample(600, 1, 639.72),
  sample(600, 2, 613.55),
  sample(800, 1, 639.96),
  sample(800, 2, 613.42),
  sample(1000, 1, 640.02),
  sample(1000, 2, 613.3)
];
...
export const tap2Trace2046 = [
  ...
  sample(950, 1, 639.1),
  sample(950, 2, 609.48),
  sample(1150, 1, 639.86),
  sample(1150, 2, 609.36)
];
...
export const laterIdleFalsePositiveTrace = [
  ...
  sample(600, 2, 609.36),
  sample(800, 2, 609.12),
  sample(1000, 2, 609.38),
  sample(1200, 2, 608.96),
  sample(1400, 2, 609.4),
  sample(1600, 2, 609.32)
];
