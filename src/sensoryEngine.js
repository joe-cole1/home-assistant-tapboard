import { SCALE_LABELS, SENSORY_AXES, STYLE_BASELINES } from './sensoryMappings.js';

export const RULES_VERSION = 'sensory-v2';
...
export function buildSensoryModel({ summary = {}, detail = {} } = {}) {
...
export function buildSensoryProfile({ summary = {}, detail = {}, override = {} } = {}) {
  const safeSummary = object(summary);
  const safeDetail = object(detail);
  const model = buildSensoryModel({ summary: safeSummary, detail: safeDetail });
